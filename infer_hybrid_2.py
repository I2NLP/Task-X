"""
Inference script for DistilBERT-BiLSTM-MultiHeadAttention model.

Usage:
    python infer_distilbert_lstm.py
"""
...
from train_distilbert_lstm import DistilBertBiLSTMAttention
...
def main():
    ...
    CONFIG = {
        ...
        'dropout': 0.3,
        'model_path': 'distilbert-lstm-attention-model/best_model.pt',
    ...
    # Create zip
    zip_file = 'submission_distilbert_lstm.zip'
    ...
    print("\nDone! Submit submission_distilbert_lstm.zip to CodaBench.")
